    ...
    <Layout>
      <div className="mb-6 animate-fade-in-down">
        <div className="flex items-center gap-3">
          ...
          <div><h1 className="text-2xl font-bold text-primary-900">Buat Kelompok</h1><p className="text-sm text-slate-500">Buat kelompok mahasiswa baru</p></div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-card border border-slate-100/80 overflow-hidden" id="form-tambah-kelompok">
          ...
          <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3">
            ...
            <button type="submit" disabled={isSubmitting}
              ...
              {isSubmitting ? <><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> Menyimpan...</> : '💾 Buat Kelompok'}
            </button>
          </div>
        </form>
      </div>
