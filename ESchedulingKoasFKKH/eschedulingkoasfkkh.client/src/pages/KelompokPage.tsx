    ...
    <div className="min-h-screen bg-white">
      <main className="max-w-7xl mx-auto px-4 py-8">
        <PageHeader 
          ...
          description="Buat dan kelola kelompok mahasiswa untuk stase"
          icon="👥"
        />
        ...
        <div className="mt-8 bg-gray-50 rounded-lg border border-gray-200 p-6">
          <div className="text-center py-12">
            <p className="text-gray-500">Belum ada data kelompok</p>
            <p className="text-sm text-gray-400 mt-1">Mulai dengan membuat kelompok baru</p>
          </div>
        </div>
      </main>
    </div>
