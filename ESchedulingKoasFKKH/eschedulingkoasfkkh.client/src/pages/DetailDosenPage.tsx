          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-500">{dosen?.nip || 'Memuat...'}</span>
              </div>
              <h1 className="text-2xl font-bold text-primary-900 mt-0.5">
                {dosen ? dosen.nama : 'Detail Dosen'}
              </h1>
            </div>
          </div>
            ...
            {isAdmin && dosen && (
              <>
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-medium rounded-xl shadow-md hover:shadow-glow-green transition-all duration-200 text-sm flex items-center gap-2 cursor-pointer"
                >
