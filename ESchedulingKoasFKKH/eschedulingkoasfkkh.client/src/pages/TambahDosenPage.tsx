...
import { DosenIcon, SaveIcon, InfoIcon } from '../components/Icons';
      ...
      <div className="max-w-3xl animate-fade-in-up">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-card border border-slate-100/80 overflow-hidden" id="form-tambah-dosen">
          <div className="p-6 border-b border-slate-100 bg-gradient-to-r from-emerald-50 to-green-50">
            ...
            <p className="mt-1 text-xs text-green-600 font-medium flex items-center gap-1.5">
              <InfoIcon className="w-4 h-4 flex-shrink-0" />
              <span>Informasi: Akun dosen akan otomatis dibuat dengan <b>Username</b> dan <b>Password</b> menggunakan NIP dosen tersebut.</span>
            </p>
          </div>
